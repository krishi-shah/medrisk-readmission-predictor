...
class PatientFeatures(BaseModel):
    ...
    num_emergency_visits: int = Field(0, ge=0)
    num_inpatient_visits: int = Field(0, ge=0)
    num_outpatient_visits: int = Field(0, ge=0)
    lab_procedure_intensity: float = Field(0.0, ge=0.0)
    procedure_intensity: float = Field(0.0, ge=0.0)
    medication_intensity: float = Field(0.0, ge=0.0)
    diagnosis_complexity: float = Field(0.0, ge=0.0)
    med_change_ratio: float = Field(0.0, ge=0.0)
    A1Cresult_abnormal: int = Field(0, ge=0, le=1)
    diabetesMed_flag: int = Field(0, ge=0, le=1)
    change_flag: int = Field(0, ge=0, le=1)
    ...
    discharge_disposition_grouped: str = Field("Other")
    admission_source_grouped: str = Field("Other")
        ...
        "examples": [
            {
                ...
                "lab_procedure_intensity": 14.67,
                "procedure_intensity": 0.33,
                "medication_intensity": 4.33,
                "diagnosis_complexity": 3.0,
                "med_change_ratio": 0.25,
                "A1Cresult_abnormal": 0,
                "diabetesMed_flag": 1,
                "change_flag": 0,
                "race": "Caucasian",
                "gender": "Female",
                ...
                "admission_type_id": "1",
                "discharge_disposition_grouped": "Home",
                "admission_source_grouped": "Emergency",
            }
        ]
    }}
